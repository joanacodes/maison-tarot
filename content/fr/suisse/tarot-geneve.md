---
title: Ateliers de tarot à Genève — en ligne et en personne, en français
description: 'Apprendre à lire le tarot depuis Genève (canton de Genève) : ateliers
  et sessions en ligne à votre heure, prix en CHF, ateliers en personne quand la Maison
...
timezoneLabel: Genève
hreflangRegion: fr-CH
areaServed:
- Genève, Suisse romande
h1: Le tarot à <em>Genève</em>
intro: 'Depuis Paris, la Maison propose aux gens de Genève des sessions et des ateliers
...
tags:
- tarot Genève
- atelier tarot Genève
- cours de tarot Genève
faq:
- q: Les ateliers en ligne sont-ils à l’heure de Genève ?
  a: Ils sont annoncés en heure de Paris et s’affichent dans votre fuseau à la réservation.
    Un atelier en ligne à 19 h, heure de Paris, c’est 19 h à Genève.
- q: Puis-je payer en CHF ?
  a: Oui. Les prix s’affichent en CHF à la réservation, TTC, dès que le processeur
    de paiement est validé.
- q: La Maison fait-elle des lectures à Genève ?
...
local:
  ...
  events: []
  traditions: []
translationKey: metro-suisse-geneve
---
## Apprendre le tarot depuis Genève {#depuis}

Tout ce que la Maison enseigne s’apprend en ligne, en visio, à douze personnes au plus pour les [ateliers](/fr/ateliers/) et seul·e avec l’hôte pour les [sessions](/fr/sessions/). Un atelier en ligne à 19 h, heure de Paris, c’est 19 h à Genève. Les créneaux s’affichent automatiquement dans votre fuseau, et les prix en CHF.
...
## Quand la Maison vient à Genève {#en-personne}

Les ateliers en personne s’organisent ville par ville, quand il y a assez de monde pour une table de douze. Ils s’affichent sur cette page et sur la page [Événements](/fr/evenements/) dès qu’ils existent ; le Guide vous prévient. Si vous êtes plusieurs à Genève à vouloir un atelier, [écrivez-nous](/fr/contact/) : c’est comme ça qu’ils naissent.

## Ce que la Maison ne fait pas, à Genève comme ailleurs {#refus}
